...
@Composable
fun HazardousAsteroidDetailScreen(
    asteroidId: String,
    onNavigateBack: () -> Unit,
    ...
    // Find the asteroid from the state
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Data provided by NASA's Near-Earth Object Web Service (NeoWs). Distances are measured in Astronomical Units (AU), where 1 AU ≈ 150 million kilometers.",
                    fontSize = 12.sp,
